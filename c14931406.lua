...
function c14931406.initial_effect(c)
	...
	e1:SetCountLimit(1,14931406,EFFECT_COUNT_CODE_OATH)
...
function c14931406.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and (Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0 or Duel.IsExistingMatchingCard(c14931406.spfilter,tp,LOCATION_MZONE,0,1,nil))
end
function c14931406.splimit(e,c,sump,sumtype,sumpos,targetp,se)
