...
function c14941412.initial_effect(c)
	...
	e2:SetCondition(c14941412.spcon)
	e2:SetTarget(c14941412.tglimit)
...
function c14941412.tglimit(e,c)
	return c:IsType(TYPE_MONSTER) and c:IsRankAbove(1) and c~=e:GetHandler()
end
