...
function c81260110.initial_effect(c)
	...
	c:EnableReviveLimit()
	Xyz.AddProcedure(c,c81260110.mfilter,4,2)
...
--엑시즈 소환
function c81260110.mfilter(c,lc,sumtype,tp)
	return c:IsRace(RACE_MACHINE,lc,sumtype,tp) and c:IsAttribute(ATTRIBUTE_EARTH,lc,sumtype,tp)
end
