...
function c81260000.initial_effect(c)
	...
	c:EnableReviveLimit()
	Synchro.AddProcedure(c,nil,1,1,Synchro.NonTunerEx(c81260000.mat),2,99)
...
--소재
function c81260000.mat(c,val,scard,sumtype,tp)
	return c:IsRace(RACE_MACHINE,val,scard,sumtype,tp) and c:IsAttribute(ATTRIBUTE_EARTH,val,scard,sumtype,tp)
end
