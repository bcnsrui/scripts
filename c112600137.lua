...
function c112600137.initial_effect(c)
	--link summon
	Link.AddProcedure(c,nil,2,2,c112600137.lcheck)
	c:EnableReviveLimit()
	--spsummon
...
function c112600137.lcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0xe89,TYPE_LINK,lc,sumtype,tp)
end
