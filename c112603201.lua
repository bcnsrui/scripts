...
function cm.initial_effect(c)
	...
	e1:SetCountLimit(1,m+2,EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(cm.ththth)
	...
	ea:SetCountLimit(1,m+3,EFFECT_COUNT_CODE_OATH)
...
function cm.ththth(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
