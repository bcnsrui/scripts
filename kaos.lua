...
function kaos.stqfilter(c,e,tp)
	return c:IsSetCard(0xe81) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
--　 효과 트리거
function kaos.sansofilter(c)
	return c:IsCode(112603082) and not c:IsDisabled()
end
function kaos.ksrgcon1(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(r,REASON_EFFECT)~=0 
	and e:GetHandler():IsPreviousLocation(LOCATION_MZONE) 
	and e:GetHandler():GetPreviousControler()==tp
	and not Duel.IsExistingMatchingCard(kaos.sansofilter,tp,LOCATION_FZONE,0,1,nil)
end
function kaos.ksrgcon2(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(kaos.sansofilter,tp,LOCATION_FZONE,0,1,nil)
end
