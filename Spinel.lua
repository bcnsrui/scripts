	...
	if e:GetCode()==EFFECT_CANNOT_SPECIAL_SUMMON then
		...
		if target==nil then
			e:SetTarget(function(e,c,sump,sumtype,sumpos,targetp,se)
				...
				--end
			return Duel.GetFlagEffect(c:GetControler(),c:GetOriginalCode()+99000351)==0
			end)
		else
			e:SetTarget(function(e,c,sump,sumtype,sumpos,targetp,se)
				--for i,eff in ipairs(ZeronierTable) do
				...
				--end
			return target(e,c,sump,sumtype,sumpos,targetp,se) and Duel.GetFlagEffect(c:GetControler(),c:GetOriginalCode()+99000351)==0
			end)
		end
	end
	cregeff(c,e,forced,...)
