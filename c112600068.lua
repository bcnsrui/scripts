...
function cm.spfilter(c,e,tp,mc)
	return c:IsSetCard(0xe82) and bit.band(c:GetType(),0x81)==0x81 and (not c.mat_filter or c.mat_filter(mc))
...
function cm.thfilter(c)
	return c:IsSetCard(0xe82) and not c:IsCode(m) and c:IsType(TYPE_SPELL) and c:IsAbleToHand()
end
