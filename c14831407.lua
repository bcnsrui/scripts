...
function c14831407.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		local mg2=Duel.GetMatchingGroup(c14831407.ofilter,tp,LOCATION_HAND+LOCATION_ONFIELD,0,nil)
		local res=Duel.IsExistingMatchingCard(c14831407.spfilter,tp,LOCATION_EXTRA,0,1,nil,e,tp,mg2,mg2,nil,chkf)
		if not res then
...
function c14831407.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local mg2=Duel.GetMatchingGroup(c14831407.ofilter,tp,LOCATION_HAND+LOCATION_ONFIELD,0,nil):Filter(c14831407.filter,nil,e)
