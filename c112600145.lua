...
function c112600145.initial_effect(c)
	--link summon
	Link.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsAttribute,ATTRIBUTE_EARTH),2,2,c112600145.lcheck)
	c:EnableReviveLimit()
	--tograve
