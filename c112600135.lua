...
function c112600135.initial_effect(c)
	--link summon
	Link.AddProcedure(c,nil,2,2,c112600135.lcheck)
	c:EnableReviveLimit()
	--draw
	...
	e4:SetCountLimit(1,112600135)
	e4:SetCondition(c112600135.tkcn)
	e4:SetTarget(c112600135.tktg)
	e4:SetOperation(c112600135.tkop)
	c:RegisterEffect(e4)
end
function c112600135.lcheck(g,lc,sumtype,tp)
	return g:IsExists(Card.IsSetCard,1,nil,0xe89,TYPE_TOKEN,lc,sumtype,tp)
end
