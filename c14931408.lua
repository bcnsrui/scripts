...
function c14931408.initial_effect(c)
	...
	e1:SetCountLimit(1,14931408,EFFECT_COUNT_CODE_OATH)
	...
	e3:SetCountLimit(1,114931408)
	e3:SetCondition(c14931408.shcon)
	c:RegisterEffect(e3)
	--spsuccess
	...
	e4:SetCountLimit(1,149314081)
	e4:SetCost(c14931408.thcost)
	e4:SetTarget(c14931408.thtg)
	e4:SetOperation(c14931408.thop)
	c:RegisterEffect(e4)
end
function c14931408.spfilter(c)
	return c:IsFaceup() and c:IsSetCard(0xb93) and c:IsType(TYPE_TOKEN)
end
