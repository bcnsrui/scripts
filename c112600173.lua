...
function cm.initial_effect(c)
	--synchro summon
	c:EnableReviveLimit()
	Synchro.AddProcedure(c,nil,1,1,Synchro.NonTuner(Card.IsAttribute,ATTRIBUTE_WATER),1,99,cm.matfilter1)
	--to hand
...
function cm.matfilter1(c,scard,sumtype,tp)
	return c:IsType(TYPE_MONSTER,scard,sumtype,tp) and c:IsSetCard(0xe8a,scard,sumtype,tp)
end
